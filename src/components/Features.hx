    ...
    return React.createElement('section', { id: 'features', className: 'section' }, [
      ...
      React.createElement('div', { className: 'features-grid' }, [
        React.createElement('div', { className: 'feature-card' }, [
          React.createElement('img', { src: 'public/assets/hdevm_1.png', alt: 'AI DevOps Pipeline' }),
        ...
        React.createElement('div', { className: 'feature-card' }, [
          React.createElement('img', { src: 'public/assets/xrd.png', alt: 'Multi-Target Haxe Development' }),
        ...
        React.createElement('div', { className: 'feature-card' }, [
          React.createElement('img', { src: 'public/assets/tb_3.png', alt: 'Human + AI Collaboration' }),
